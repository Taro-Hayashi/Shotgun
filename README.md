...
- テスト用ファームウェア [shotgun_test.hex](https://github.com/Taro-Hayashi/Shotgun/releases/download/14.20/shotgun_test.hex)
...
- [shotgun_via.hex](https://github.com/Taro-Hayashi/Shotgun/releases/download/14.20/shotgun_via.hex)
